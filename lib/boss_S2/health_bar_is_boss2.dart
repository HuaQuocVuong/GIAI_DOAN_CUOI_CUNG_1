...
class Boss2HealthBar extends PositionComponent {
  ...
  Boss2HealthBar({required this.boss}) : super(
    size: Vector2(200, 90),
  ...
  void update(double dt) {
    ...
    if (boss.isMounted && boss.isAlive) {
      // GẮN CỐ ĐỊNH TRÊN ĐẦU BOSS - offset cố định
      position = Vector2(
        boss.position.x, // Cùng vị trí X với boss
        boss.position.y - 220 // Offset cố định phía trên boss
      );
    }
  }
}